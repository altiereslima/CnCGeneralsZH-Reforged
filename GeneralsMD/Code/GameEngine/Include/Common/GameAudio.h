...
class AudioManager : public SubsystemInterface
{
	public:
		...
		// The first parameter is the sample, 3D sample or stream handle that finished, so it is
		// pointer sized: the audio device hands its own handles back through here.
