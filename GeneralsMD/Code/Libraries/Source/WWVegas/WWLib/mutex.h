...
public:
	...
	public:
		...
		{
		  // EA's "lock bts" loop, as the intrinsic that compiles to the same instruction on x86 and
		  // x64.  The asm also loaded the flag's address into EBX without saving it.
