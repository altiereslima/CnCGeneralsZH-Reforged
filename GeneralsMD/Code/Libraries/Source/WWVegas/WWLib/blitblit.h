...
/*
**	EA had assembly specializations of the blitters above for 8 and 16 bit surfaces here, in
**	32-bit inline __asm.  The templates they specialized are what the build uses.
*/
