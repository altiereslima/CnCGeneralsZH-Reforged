...
- Watching, every player's net worth is on screen under the strips drop-down, the way Dota shows it: richest first, the general's portrait, the number in gold, and a thin line measured against the richest player that ends in a bright dot, green for one side and red for the other in a two-sided match and each player's own colour in a free for all. Net worth is the cash in hand plus what everything the player has standing would cost to build again, counted twice a second.
- The number that list ranks by is yours to pick, as in Dota's game stats. Click the dark bar above the list and it opens into net worth, cash, income per minute, army value, kills and losses, the general's rank and power; the list re-sorts the moment you choose.
- The first of the two square buttons beside that bar opens a graph of the net worth lead since the first minute: green above the line while the first team is ahead, red below while the second is, with how far ahead the leader is right now. It needs a match with two sides.
- The second opens the armies chart: every player's six most expensive kinds of unit, with how many of each he has on the field.
...
- A building stands on the ground instead of sitting on top of it. There is a soft patch under every
  ...
  treatment through the finishing passes.
