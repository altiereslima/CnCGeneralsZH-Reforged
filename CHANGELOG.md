...
- The function row is your generals powers, key for key with the strip on screen. Each one brightens as it charges, blinks white for three seconds when it comes ready and then holds steady. A power you have not bought yet stays dark. F7 lit means F7 is worth pressing.
